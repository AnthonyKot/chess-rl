...
class BenchmarkMetricsCollector {
     ...
     */
    private fun getIllegalMoveCount(@Suppress("UNUSED_PARAMETER") session: LearningSession): Int {
        return try {
     ...
     * Calculate training time per cycle.
     */
    private fun calculateTrainingTimePerCycle(@Suppress("UNUSED_PARAMETER") session: LearningSession): Long {
