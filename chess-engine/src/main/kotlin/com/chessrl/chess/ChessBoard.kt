...
data class ChessBoard(
    ...
    fun initializeStandardPosition() {
        ...
        // Reset game state to the standard starting position
    ...
    fun clearBoard() {
        ...
        // Reset game state to a neutral setup
        gameState.activeColor = PieceColor.WHITE
    ...
    /**
     * Explicitly configure castling rights for testing or custom setups
     */
    fun setCastlingRights(
        ...
        gameState.whiteCanCastleKingside = whiteCanCastleKingside
        gameState.whiteCanCastleQueenside = whiteCanCastleQueenside
        gameState.blackCanCastleKingside = blackCanCastleKingside
        gameState.blackCanCastleQueenside = blackCanCastleQueenside
    }
    ...
    fun deepCopy(): ChessBoard {
        ...
        newBoard.gameState.activeColor = gameState.activeColor
        newBoard.gameState.whiteCanCastleKingside = gameState.whiteCanCastleKingside
        newBoard.gameState.whiteCanCastleQueenside = gameState.whiteCanCastleQueenside
        newBoard.gameState.blackCanCastleKingside = gameState.blackCanCastleKingside
        newBoard.gameState.blackCanCastleQueenside = gameState.blackCanCastleQueenside
        newBoard.gameState.enPassantTarget = gameState.enPassantTarget?.let { Position(it.rank, it.file) }
        newBoard.gameState.halfmoveClock = gameState.halfmoveClock
        newBoard.gameState.fullmoveNumber = gameState.fullmoveNumber
        return newBoard
    }
...
class ChessGame {
     ...
     */
    fun getCurrentBoard(): ChessBoard = board.deepCopy()
